...
| Native Wine | <https://www.winehq.org/> | Adopt with exact pin | Direct execution and no launcher daemon; wrapper 0.1.1 accepts only the audited Arch 11.15-1 payload. |
